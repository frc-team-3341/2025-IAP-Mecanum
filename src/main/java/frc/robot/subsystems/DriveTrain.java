...
public class DriveTrain extends SubsystemBase {
    ...
    private final SparkMax frontLeftMotor = new SparkMax(6,SparkMax.MotorType.kBrushless);
    private final SparkMax backLeftMotor = new SparkMax(5,SparkMax.MotorType.kBrushless);
    private final SparkMax frontRightMotor = new SparkMax(7,SparkMax.MotorType.kBrushless);
